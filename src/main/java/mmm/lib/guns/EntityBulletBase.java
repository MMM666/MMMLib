...
//			setLocationAndAngles(posX, posY, posZ, rotationYaw, rotationPitch);
	...
	public void onUpdate() {
		...
		Vec3 lvo = worldObj.getWorldVec3Pool().getVecFromPool(posX, posY, posZ);
		Vec3 lvt = worldObj.getWorldVec3Pool().getVecFromPool(
...
//			movingobjectposition = worldObj.rayTraceBlocks(lvo, lvt, true);
			...
			lvt = worldObj.getWorldVec3Pool().getVecFromPool(
					posX + motionX, posY + motionY, posZ + motionZ);
