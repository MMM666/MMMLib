package mmm.lib.model;

import static mmm.lib.model.IModelCaps.*;
...
//					itemstack.getItemDamage(), lsowner);
			TileEntitySkullRenderer.field_147536_b.func_147530_a(-0.5F, 0.0F, -0.5F, 1, 180.0F, itemstack.getItemDamage(), lsowner);
